    ...
    case 0x8015:
        return [
            0x100006868: [
                0x21, 0x00, 0x80, 0x52, // movz w1, #0x1
                0x1F, 0x20, 0x03, 0xD5, // nop
                0xE1, 0x87, 0x04, 0x39, // strb w1, [sp, #0x121]
                0xE1, 0x8B, 0x04, 0x39, // strb w1, [sp, #0x122]
                0x39, 0x00, 0x80, 0x52, // movz w25, #0x1
                0x1F, 0x20, 0x03, 0xD5, // nop
                0x1F, 0x20, 0x03, 0xD5, // nop
            ],

            0x100006838: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x10000685C: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x100006810: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x1000067FC: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x10000678C: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x100006784: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x100006618: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x10000663C: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x10000665C: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x100006668: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x1000066A0: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x1000066AC: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x1000066C8: [ 0x1F, 0x20, 0x03, 0xD5 ], // nop
            0x1000067C4: [ 0x1C, 0x00, 0x00, 0x14 ], // b #0x70
            0x100006750: [ 0x09, 0x00, 0x00, 0x14 ], // b #0x24
            0x100006268: [ 0x00, 0x00, 0x80, 0xD2 ], // mov x0, #0x0
            0x10000626C: [ 0x00, 0x00, 0x80, 0xD2 ], // ret
        ]
